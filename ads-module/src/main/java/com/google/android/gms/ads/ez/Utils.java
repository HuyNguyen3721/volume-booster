...
public class Utils {
    ...
    public static String getTopActivity(Context context) {
        ...
        LogUtils.logString(Utils.class, "Top Activity 1" + EzApplication.getInstance().getCurrentActivity().getClass().getName());


        if (taskInfo != null && taskInfo.size() > 0) {
            return taskInfo.get(0).topActivity.getClassName().equals("") ? EzApplication.getInstance().getCurrentActivity().getClass().getName() : taskInfo.get(0).topActivity.getClassName();
        } else {
