...
public class AdUnit {
    ...
    public static int getPriorityOpenAds() {
        return AdUnitFactory.getInstance(TEST).getPriorityOpenAds();
    }

    public static String getUnityAppId() {
        String id = AdUnitFactory.getInstance(TEST).getUnityAppId();
        return id == null ? "" : id;
    }

    public static String getUnityAdUnitId() {
        String id = AdUnitFactory.getInstance(TEST).getUnityAdUnitId();
        return id == null ? "" : id;
    }

    public static String getIrcAppId() {
        String id = AdUnitFactory.getInstance(TEST).getIrcAppId();
        return id == null ? "" : id;
    }
